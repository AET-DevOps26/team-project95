    ...
    <main className={styles.page}>
      ...
      <section className={styles.content}>
        ...
        <div className={styles.sectionCard}>
          ...
          <p>
            This thesis focuses on developing and evaluating semantic search methods to improve the discovery of open
            thesis opportunities. The goal is to go beyond keyword matching by understanding the meaning and context of
            thesis descriptions.
          </p>
          <p>
            The work includes exploring semantic embedding models, building a prototype search system, and evaluating
            results based on relevance and user feedback.
          </p>
        </div>
        ...
        <div className={styles.sectionCard}>
          ...
          <p>
            ...
            The objective is to analyze candidate cryptographic schemes, evaluate integration constraints, and prototype
            a practical architecture for low-latency embedded environments.
          </p>
        </div>
        ...
        <div className={styles.bottomCta}>
          ...
          <a href={sourceUrl} target="_blank" rel="noreferrer" className={`${styles.visitSourceButton} ${styles.clickableButton}`}>
