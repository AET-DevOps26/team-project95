...
public class VectorSearchController implements InternalApi {
    ...
    public VectorSearchController(ThesisVectorSearchService thesisVectorSearchService,
    ...
    @Override
    public ResponseEntity<VectorSearchResponse> semanticSearch(VectorSearchRequest vectorSearchRequest) {
        return ResponseEntity.ok(thesisVectorSearchService.semanticSearch(vectorSearchRequest));
    }

    @Override
    public ResponseEntity<ReplaceChairVectorsResponse> indexChairTheses(Long chairId,
                                                                        ReplaceChairVectorsRequest replaceChairVectorsRequest) {
        return ResponseEntity.ok(thesisVectorIndexService.indexChairTheses(chairId, replaceChairVectorsRequest));
    }
    ...
    @Override
    public ResponseEntity<GenAIExtractionResponse> extractThesesFromRawContent(GenAIExtractionRequest genAIExtractionRequest) {
    ...
    @Override
    public ResponseEntity<ChairThesesReplacementResponse> replaceChairTheses(Long chairId,
                                                                             ChairThesesReplacementRequest chairThesesReplacementRequest) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED).build();
    }
