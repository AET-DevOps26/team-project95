...
ALTER TABLE scrape_runs ADD COLUMN raw_html_snapshot TEXT;

-- Remove the column from thesis_proposals
ALTER TABLE thesis_proposals DROP COLUMN raw_html_snapshot;

-- Remove extraction_confidence from thesis_proposals (previously removed from OpenAPI/Domain without migration)
ALTER TABLE thesis_proposals DROP COLUMN extraction_confidence;
